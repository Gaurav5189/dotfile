...
hl.bind(mainMod .. " + I", hl.dsp.exec_cmd("/home/gav/.local/share/antigravity/antigravity-ide --enable-features=UseOzonePlatform --ozone-platform=wayland"), { description = "Open Antigravity IDE" })
...
hl.bind(mainMod .. " + PRINT", hl.dsp.exec_cmd("~/.config/hypr/scripts/screenshot-swappy.sh"), { description = "Take a screenshot" })
