...
hl.bind(mainMod .. " + I", hl.dsp.exec_cmd("/home/gav/.local/share/antigravity/antigravity-ide --ozone-platform=x11"), { description = "Open Antigravity IDE" })
...
hl.bind(mainMod .. " + PRINT", hl.dsp.exec_cmd("~/.config/hypr/scripts/mac-screenshot.sh"), { description = "Capture an area with preview actions" })
hl.bind(mainMod .. " + ALT + F", hl.dsp.exec_cmd("~/.config/hypr/scripts/mac-screenshot.sh --full"), { description = "Capture the full screen with preview actions" })
hl.bind(mainMod .. " + ALT + S", hl.dsp.exec_cmd("~/.config/hypr/scripts/mac-screenshot.sh --area --freeze"), { description = "Capture a frozen area with preview actions" })
